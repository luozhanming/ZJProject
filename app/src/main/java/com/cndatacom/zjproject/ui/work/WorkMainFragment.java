...
public class WorkMainFragment extends Fragment {
    ...
    private void initData() {
        ...
        entry1.setIcon(R.mipmap.ic_launcher);
        entry1.setName("OA审批");
        FunctionEntry entry2 = new FunctionEntry();
        entry2.setIcon(R.mipmap.ic_launcher);
        entry2.setName("云办事");
        FunctionEntry entry3 = new FunctionEntry();
        entry3.setIcon(R.mipmap.ic_launcher);
        entry3.setName("云订餐");
        FunctionEntry entry4 = new FunctionEntry();
        entry4.setIcon(R.mipmap.ic_launcher);
        entry4.setName("通知公告");
        FunctionEntry entry5 = new FunctionEntry();
        entry5.setIcon(R.mipmap.ic_launcher);
        entry5.setName("督办系统");
        FunctionEntry entry6 = new FunctionEntry();
        entry6.setIcon(R.mipmap.ic_launcher);
        entry6.setName("视频电话");
        FunctionEntry entry7 = new FunctionEntry();
        entry7.setIcon(R.mipmap.ic_launcher);
        entry7.setName("内部邮件");
