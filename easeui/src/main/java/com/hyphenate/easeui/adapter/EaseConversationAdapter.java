...
//                Glide.with(getContext()).load(user.getAvatorUrl()).into(holder.avatar);
//            }else{
    ...
    private class ConversationFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence prefix) {
            ...
            if (prefix == null || prefix.length() == 0) {
                clearMultiValues(copyConversationList);
        ...
        //去除重复的结果算法
        private void clearMultiValues(List<EMConversation> newValues) {
            List<String> tempList = new ArrayList<>();
            List<Integer> multiPos = new ArrayList<>();
            ...
            for (Integer multi : multiPos) {
                newValues.remove(multi.intValue());
            }
        }
